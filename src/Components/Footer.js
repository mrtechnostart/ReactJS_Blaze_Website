          ...
          <div className="container mt-5">
            <div className="row py-4">
              <div className="col-md-4 text-center text-md-start">
                ...
                <p className="mb-0 text-muted">H-201, Type 4B, IET Campus, Sitapur Road, Lucknow-226021</p>
              </div>
            ...
            {/* <div className="text-center my-4">
              <p className="text-muted mb-0">Made with &hearts; by <a href="https://www.linkedin.com/in/mrtechnostart/" className="text-danger text-decoration-none fw-bold" target={"_blank"} rel="noreferrer">Team Blaze</a></p>
            </div> */}
          </div>
        </footer>
      </div>
